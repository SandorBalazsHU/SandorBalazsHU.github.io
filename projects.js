const PROJECTS = [
  {
    ...
    description: "A modular LED cube controller based on shift registers, transistor layer switching and handmade wiring.",
    image: "img/led-cube.jpg",
    github: "https://github.com/sandorbalazs9402",
    tags: ["Arduino", "74HC595", "KiCad"],
    status: "Active",
    type: "Hardware",
    year: "2026"
  },
  {
    ...
    description: "A C++ and Python based measurement project for collecting, analyzing and visualizing hardware random values.",
    image: "img/random-test.jpg",
    github: "https://github.com/sandorbalazs9402",
    tags: ["C++", "Python", "Analysis"],
    status: "Prototype",
    type: "Software",
    year: "2026"
  },
  {
    category: "featured",
    rank: 3,
    name: "Z80 BASIC Computer Concept",
    description: "A planned retrocomputer project designed around a proven Z80 BASIC ROM and custom hardware architecture.",
    image: "img/z80-basic.jpg",
    github: "https://github.com/sandorbalazs9402",
    tags: ["Z80", "BASIC", "Digital logic"],
    status: "Planned",
    type: "Retrocomputing",
    year: "2026"
  },
